  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
      ...
      <div className='md:w-1/2 space-y-6'>
        ...
        <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab dignissimos fugiat accusantium voluptates repellendus in enim minus facilis tempore esse omnis nisi voluptatem, qui vero? Quasi ea ut eveniet inventore!</p>
